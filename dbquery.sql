...
INSERT INTO `appointment_sched` (`sched_id`, `Services_id`, `ScheduleDate`, `customer_id`, `appointment_type`, `appointment_description`, `project_id`) VALUES
...
(201, 10, 1, 1850.00, '2025-10-27 21:27:36', 'Completed', 0, 9001),
(202, 12, 3, 505.00, '2025-10-27 21:23:04', 'Ongoing', 0, 9002),
(203, 11, 2, 850.00, '2025-10-04 19:00:00', 'Pending', 0, NULL);
...
(9001, 201, 1850.00, 'Bank Transfer', 'TXN789012', '2025-10-18 22:45:52'),
(9002, 202, 505.00, 'Credit Card', 'TXN789013', '2025-10-18 22:45:52'),
(9003, NULL, 300.00, 'Cash', 'TXN789014', '2025-10-09 18:00:00');
...
(1, 1, '2025-09-16 22:00:00', 'All hardware installed and configured.'),
(2, 2, '2025-10-05 17:30:00', 'OS installation started.');
...
(1, 201, NULL, '2025-11-05', NULL, 'Pending', 'Initial network setup for new office building.', 1850.00),
(2, 202, NULL, '2025-10-05', NULL, 'Ongoing', 'Piste yawa patya ko daan ayha nako humanon, bahalag akong kalag nalay mo himo sa code', 505.00);
...
(104, 'Rohan Augusto', 'diri sa la salle', '`02903`019209`013', 'rohan@alg.com', '$2y$10$EutZSLViY5qaC70JwKKrEOr8zCyC.JTb5bdl9dQGM7NMvw.FVp6hi', 'Admin', 'Document');
...
ALTER TABLE `appointment_sched`
  ADD CONSTRAINT `appointment_sched_ibfk_1` FOREIGN KEY (`Services_id`) REFERENCES `services` (`Services_id`),
