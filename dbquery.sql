...
CREATE TABLE `Orders` (
    ...
    -- Custom columns for application logic
    `status` ENUM('Pending', 'Ongoing', 'Completed', 'Dismissed') NOT NULL, -- Matched to PHP logic
    `schedule_date` DATETIME,                                           -- For calendar
    `stock_adjusted` TINYINT(1) DEFAULT 0,                              -- For inventory
...
CREATE TABLE ProductImports (
    ...
    -- Payment_id removed for simple imports
    FOREIGN KEY (Supplier_id) REFERENCES Supplier(Supplier_id),
    FOREIGN KEY (Product_id) REFERENCES Product(Product_id)
);
...
-- Product Imports Data
INSERT INTO ProductImports (Product_id, Supplier_id, Quantity, Price, ImportDate) VALUES
(1, 1, 100, 85.50, '2025-04-02'),(2, 2, 60, 65.00, '2025-04-04'),(3, 3, 30, 120.75, '2025-04-06'),(4, 1, 40, 105.25, '2025-04-08'),(5, 2, 50, 250.00, '2025-04-10'),
(6, 4, 70, 180.50, '2025-04-13'),(7, 3, 25, 220.00, '2025-04-16'),(8, 5, 75, 45.00, '2025-04-19'),(9, 2, 90, 35.00, '2025-04-23'),(10, 4, 80, 15.00, '2025-04-28'),
(11, 3, 55, 150.00, '2025-05-02'),(12, 1, 40, 25.00, '2025-05-04'),(13, 5, 60, 175.00, '2025-05-07'),(14, 2, 20, 180.00, '2025-05-09'),(15, 4, 45, 95.00, '2025-05-12'),
(16, 1, 65, 70.00, '2025-05-15'),(17, 3, 35, 275.00, '2025-05-19'),(18, 2, 50, 60.00, '2025-05-21'),(19, 5, 100, 10.00, '2025-05-24'),(20, 4, 85, 55.00, '2025-05-29'),
(21, 1, 15, 190.00, '2025-06-01'),(1, 2, 110, 85.50, '2025-06-03'),(2, 3, 55, 65.00, '2025-06-05'),(3, 4, 35, 120.75, '2025-06-08'),(4, 5, 45, 105.25, '2025-06-10'),
(5, 1, 75, 250.00, '2025-06-14'),(6, 2, 50, 180.50, '2025-06-17'),(7, 3, 30, 220.00, '2025-06-21'),(8, 4, 95, 45.00, '2025-06-25'),(9, 5, 70, 35.00, '2025-06-29'),
(10, 1, 90, 15.00, '2025-07-02'),(11, 2, 35, 150.00, '2025-07-04'),(12, 3, 60, 25.00, '2025-07-07'),(13, 4, 50, 175.00, '2025-07-09'),(14, 5, 25, 180.00, '2025-07-12'),
(15, 1, 55, 95.00, '2025-07-15'),(16, 2, 70, 70.00, '2025-07-18'),(17, 3, 40, 275.00, '2025-07-21'),(18, 4, 60, 60.00, '2025-07-25'),(19, 5, 85, 10.00, '2025-07-29'),
(20, 1, 95, 55.00, '2025-08-01'),(21, 2, 20, 190.00, '2025-08-03'),(1, 3, 120, 85.50, '2025-08-05'),(2, 4, 65, 65.00, '2025-08-08'),(3, 5, 40, 120.75, '2025-08-11'),
(4, 1, 55, 105.25, '2025-08-14'),(5, 2, 85, 250.00, '2025-08-18'),(6, 3, 45, 180.50, '2025-08-21'),(7, 4, 35, 220.00, '2025-08-25'),(8, 5, 100, 45.00, '2025-08-29'),
(9, 1, 95, 35.00, '2025-09-01'),(10, 2, 85, 15.00, '2025-09-03'),(11, 3, 45, 150.00, '2025-09-05'),(12, 4, 55, 25.00, '2025-09-08'),(13, 5, 65, 175.00, '2025-09-11'),
(14, 1, 25, 180.00, '2025-09-14'),(15, 2, 70, 95.00, '2025-09-18'),(16, 3, 90, 70.00, '2025-09-21'),(17, 4, 55, 275.00, '2025-09-24'),(18, 5, 75, 60.00, '2025-09-28');