...
--
-- Table structure for table `appointment_sched`
--

CREATE TABLE `appointment_sched` (
...
--
-- Dumping data for table `appointment_sched`
--

INSERT INTO `appointment_sched` (`sched_id`, `ScheduleDate`, `customer_id`, `appointment_type`, `appointment_description`, `project_id`) VALUES
(1, '2025-10-25 09:00:00', NULL, 'Service', 'Network setup consultation', NULL),
(2, '2025-10-25 14:00:00', NULL, 'Consultation', 'Security audit discussion', NULL),
(3, '2025-11-03 10:30:00', 4, 'Purchase Materials', 'Cable and hardware purchase', NULL);
...
CREATE TABLE `inventory_log` (
  ...
  `Change_Type` enum('PO_RECEIVED','SALE','RETURN','ADJUSTMENT','DAMAGED','OTHER') NOT NULL,
...
(201, 10, 1, 1850.00, '2025-10-27 13:27:36', 'Completed', 0, 9001),
(202, 12, 3, 505.00, '2025-10-27 13:23:04', 'Ongoing', 0, 9002),
(203, 11, 2, 850.00, '2025-10-04 11:00:00', 'Pending', 0, NULL);
...
(9001, 201, 1850.00, 'Bank Transfer', 'TXN789012', '2025-10-18 14:45:52'),
(9002, 202, 505.00, 'Credit Card', 'TXN789013', '2025-10-18 14:45:52'),
(9003, NULL, 300.00, 'Cash', 'TXN789014', '2025-10-09 10:00:00');
...
(1, 1, 501, 100, 20, 100.00, '2025-08-14'),
(2, 1, 501, 102, 500, 4.00, '2025-08-14'),
(3, 2, 502, 101, 10, 150.00, '2025-09-09');
...
(1, 1, '2025-09-16 14:00:00', 'All hardware installed and configured.'),
(2, 2, '2025-10-05 09:30:00', 'OS installation started.');
...
INSERT INTO `projects` (`Project_id`, `Orders_id`, `Project_Name`, `StartDate`, `EndDate`, `Status`, `Notes`, `Total_Cost`) VALUES
(1, 201, 'Network Setup Project', '2025-11-05', NULL, 'Completed', '', 1000.00),
(2, 202, 'Custom PC Build', '2025-10-05', NULL, 'Ongoing', 'Building custom computer for client.', 505.00);
...
INSERT INTO `project_logs` (`log_id`, `project_id`, `staff_id`, `log_date`, `location`, `notes`, `client_feedback`, `created_at`) VALUES
(1, 2, 102, '2025-11-12', 'La Salle', 'Roblox', 'Roblox', '2025-11-12 20:51:02'),
(2, 2, 103, '2025-11-13', 'La Salle', 'Ni adto sa Lasalle', 'Walay ID dala', '2025-11-13 16:50:41');
...
(3, 'PO-2025-813', 502, '2025-11-13', '0000-00-00', 0.00, 0.00, 0.00, 'Pending');
...
(101, 'Alice Smith', '123 Main St', '555-0101', 'admin@alg.com', '$2y$10$ArN044X3se8sTKrXHUPBeOns2y016XmcbcSuB4snQXTA1DFjyI9/C', 'Admin', 'General Manager'),
(102, 'Bob Johnson', '456 Oak Ave', '555-0102', 'staff@alg.com', '$2y$10$9sSyURTVy9d9QDb7umhgLuc0/rung0Xa3zYfqfMj7pwAHBxR9WvYW', 'Staff', 'Project Lead'),
(103, 'Charlie Brown', '789 Pine Ln', '555-0103', 'charlie.b@algdb.com', 'hashedpass3', 'Staff', 'Technician'),
(104, 'Rohan Augusto', 'diri sa la salle', '02903019209013', 'rohan@alg.com', '$2y$10$EutZSLViY5qaC70JwKKrEOr8zCyC.JTb5bdl9dQGM7NMvw.FVp6hi', 'Admin', 'Document');
...
--
-- Indexes for table `appointment_sched`
--
ALTER TABLE `appointment_sched`
...
--
-- AUTO_INCREMENT for table `appointment_sched`
--
ALTER TABLE `appointment_sched`
...
--
ALTER TABLE `orderitems`
  MODIFY `Items_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=310;
...
--
ALTER TABLE `projectstaff`
  MODIFY `ProjectStaff_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- Constraints for table `appointment_sched`
--
ALTER TABLE `appointment_sched`
  ADD CONSTRAINT `appointment_sched_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`Customer_id`),
  ADD CONSTRAINT `appointment_sched_ibfk_3` FOREIGN KEY (`project_id`) REFERENCES `projects` (`Project_id`);
...
ALTER TABLE `project_logs`
  ...
  ADD CONSTRAINT `project_logs_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`Staff_id`) ON DELETE CASCADE;
