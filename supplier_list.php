...
<head>
    ...
    <style>
        ...
        footer {background:#007bff;color:white;text-align:center;padding:10px;width:100%;}
        .card {background:white;padding:25px;border-radius:8px;box-shadow:0px 4px 8px rgba(0,0,0,0.1);max-width:700px;width:90%;}
...
<body>
    ...
    <main>
        <div class="card">
            <h2>Supplier List</h2>
            <table>
                <tr><th>Company</th><th>Contact Person</th><th>Email</th><th>Phone</th></tr>
                <?php
